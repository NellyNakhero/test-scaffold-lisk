    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <header className="px-6 lg:px-8 py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            <Button onClick={() => router.push("/dashboard")} variant="primary" size="large">
              Launch BaseFlow
            </Button>
          ...
          <motion.div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6" {...fadeIn}>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">"Create an invoice for $200 for the chair delivery"</div>
              </div>
              <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                <div className="text-gray-600">You:</div>
                <div className="flex-1">"How many chairs are left in stock?"</div>
              </div>
              <div className="flex items-start gap-4">
                <div className="text-blue-600">Assistant:</div>
                <div className="flex-1">"You have 3 chairs left. Would you like me to prepare a reorder?"</div>
              </div>
            </div>
          </motion.div>
        </div>
